...
- Allow calibration for drift in clocks, sensors, hardware, people, and
  external systems.
- Treat silent success as unverified.

Never remove security, accessibility, validation, error handling, privacy, or
data protection for brevity.
