...
Use names as handles, not decoration: 
Shannon = channel/noise; 
Wiener = cybernetic feedback; 
Ashby = requisite variety/control capacity;
Popper = falsification;
Deming = system measurement;
Aristotle = first principles;
Socrates = interrogation;
Ockham = no unnecessary machinery.
